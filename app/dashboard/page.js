...
export default function AdminDashboard() {
  ...
  }, [status, router]); // Re-run the effect if session status changes

  if (status === "loading") {
    // Optionally, you can show a loading spinner or some placeholder until the session is determined
